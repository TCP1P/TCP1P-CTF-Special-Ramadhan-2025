...
def login():
    ...
    for char, pw_string in zip(entered_password, password):
        ...
        success_label = tkinter.Label(success_window, text='wih gg mas, nih', bg='#0d0d0d', fg='#ff00ff', font=('Courier', 20, 'bold'))
        success_label.pack(pady=30)
        flag_label = tkinter.Label(success_window, text=f'RAMADHAN{{{entered_password}}}', bg='#0d0d0d', fg='#00ffcc', font=('Courier', 16))
